...
This repository contains the source code and assets of Flight Authentication Service . The purpose of this Repository is to Authenticate the User that is Entering into the System of Searching and The Subsequent Flights.

## Block Diagram 

![Alt text](Project-Block-Diagram.jpg)
![Alt text](Authentication-Block-Diagram.jpg)
...
* Github for free deployment of website. -->
 ...
 For Accessing My Flight Authentication Services and Interacting with My Database use- 
 * http://localhost:5001/api/v1/flights
...
Thank you for visiting my Flight Authentication service. I appriciate your Interest and support!